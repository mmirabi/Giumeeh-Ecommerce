...
//            Route::post('register', 'RegisterController@register')->name('register.post');
            ...
            Route::get('otp/send', 'OtpController@sendForm')->name('access.otp.form');
            Route::post('otp/send', 'OtpController@send')->name('access.otp.send_post');
            Route::post('otp/verify', 'OtpController@verify')->name('access.otp.verify');
