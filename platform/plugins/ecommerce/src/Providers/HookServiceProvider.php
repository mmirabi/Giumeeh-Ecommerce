...
use Botble\Payment\Services\Gateways\GatewayPaymentService;
...
class HookServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        add_filter('cms_unauthenticated_response', function ($defaultException) {
            ...
            return redirect()->guest(route('customer.access.otp.form'));
        });
        ...
        add_filter(FILTER_ECOMMERCE_PROCESS_PAYMENT, function (array $data, Request $request) {
            ...
            switch ($request->input('payment_method')) {
                ...
                case PaymentMethodEnum::GATEWAY:

                    $data['charge_id'] = $this->app->make(GatewayPaymentService::class)->execute($paymentData);
