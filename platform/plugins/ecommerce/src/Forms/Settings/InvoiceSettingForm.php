...
class InvoiceSettingForm extends SettingForm
{
    public function setup(): void
    {
        ...
        $this
            ...
            ->add('invoice_support_bangladesh_language', 'onOffCheckbox', [
                'label' => trans('plugins/ecommerce::setting.invoice.form.invoice_support_bangladesh_language'),
                'value' => get_ecommerce_setting('invoice_support_bangladesh_language', false),
                'colspan' => 6,
            ])
