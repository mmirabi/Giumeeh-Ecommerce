...
<div class="product-detail accordion-detail">
    <div class="row mb-50 mt-30 justify-content-md-center">
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
            ...
            <div class="font-xs mb-30 akband-display-flex">
...
{{--                    @endif--}}
                    ...
                    <div class="detail-extralink mb-50">
                        ...
                        @endif
                            <div class="clearfix product-price-cover mb-30 mt-30 akband-text-center akband-text-font-size">
            ...
            <div class="product-info">
                <div class="tab-style3">
                    <ul class="nav nav-tabs text-uppercase">
                        <li class="nav-item">
                            <a class="nav-link active" id="Description-tab" data-bs-toggle="tab" href="#technicialspecifications">{{ __('Technicial Specifications') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" id="Description-tab" data-bs-toggle="tab" href="#relatedproducts">{{ __('Related products') }}</a>
                        </li>
                    </ul>
                    <div class="tab-content shop_info_tab entry-main-content">
                        <div class="tab-pane fade show active" id="technicialspecifications">
                            @if ($product->variations()->count() > 0)
                                <div class="pr_switch_wrap">
                                    {{-- Render the product attributes as text --}}
                                    @foreach($product->variations() as $variation)
                                        <div class="attribute">
                                            <span class="attribute-name">{{ $attributes->name }}:</span>
                                            <span class="attribute-value">{{ $attributes->value }}</span>
                                        </div>
                                    @endforeach
                                </div>
                            @else
                                {{ __('Not Found Technical Specifications') }}
                            @endif
                        </div>
{{--                        @php--}}
{{--                        dd($product)--}}
