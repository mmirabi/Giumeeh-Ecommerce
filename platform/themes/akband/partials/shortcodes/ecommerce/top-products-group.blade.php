<section class="section-padding m-2">
    <div class="container">
        <div class="row">
            @foreach($data as $item)
                <div class="col-xl-{{ (12 / count($data)) }} col-lg-6 col-md-6 mb-md-0">
                    <div class="row">
                        <div class="col-6">
                            <h5 class="section-title style-1 mb-30 animated animated">{{ $item['title'] }}</h5>
                        </div>
                        <div class="col-6">
                            <p class="section-link-akband"> <a href="#"> {{ __('View All')  }} <i class="fi-rs-arrow-small-left"></i></a></p>
                        </div>
                    </div>
                    <div class="product-list-small animated animated">
                        @foreach($item['products'] as $product)
                            ...
                            @endphp
                            <article class="row align-items-center hover-up akband-items-homepage">
