                    ...
                    <div class="brand-logo">
                        @if ($brand->website)
                            <a href="{{ $brand->website }}">
                                <img class="default-img" src="{{ RvMedia::getImageUrl($brand->logo, null, false, RvMedia::getDefaultImage()) }}" alt="{{ $brand->name }}"/>
                            </a>
                        @else
                            <a href="{{ in_array($brand->id, request()->query('brands', [])) }}">
                                <img class="default-img" src="{{ RvMedia::getImageUrl($brand->logo, null, false, RvMedia::getDefaultImage()) }}" alt="{{ $brand->name }}"/>
                                <p>{{ $brand->name }}</p>
                            </a>
                        @endif
