...
<header class="akband-header-color header-area header-style-1 header-height-2 {{ $headerStyle }}">
                        ...
                        <div class="header-action-2">
                            ...
                            @if (EcommerceHelper::isWishlistEnabled())
                                <div class="header-action-icon-2">
                                    ...
                                    <a href="{{ route('public.wishlist') }}"></a>
                                </div>
                            @endif
                            <div class="header-action-icon-2">
                            ...
                            <div class="header-action-icon-2">
                                <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                    <ul>
                                        ...
                                        @else
                                            <div class="akband-user-login-register">
                                                <a href="{{ route('customer.access.otp.form') }}"> {{ __('Log In / Sign Up') }}</a>
                                            </div>
                                            <a href="{{ route('customer.overview') }}"></a>
            ...
            @if (theme_option('hotline'))
                <div class="hotline d-none d-lg-flex">
                    ...
                    <a href="tel:{{ theme_option('hotline') }}">
                        <p>{{ theme_option('hotline') }}
                            <span>{{ __('24/7 Support Center') }}</span>
                        </p>
                    </a>
                </div>
            @endif
    ...
    <div class="mobile-header-content-area">
        ...
        <div class="mobile-header-info-wrap">
            ...
            @if (is_plugin_active('ecommerce'))
                ...
                @endif
                <div class="single-mobile-header-info">
                    <a href="{{ route('customer.access.otp.form') }}"><i class="fi-rs-user"></i> {{ __('Log In / Sign Up') }}</a>
                </div>
            @endif
            @if (theme_option('hotline'))
                <div class="single-mobile-header-info">
